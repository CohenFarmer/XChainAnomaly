#checks if addresses have interacted with tornado cash
import pandas as pd
import numpy as np
import data.dataExtraction.alchemyGetAddressTransfers as alchemyGetAddressTransfers

#handles tornado cash address lookups
class tornadoInteraction:
    #loads tornado addresses into sorted array
    def __init__(self):
    ...
    #loads malicious addresses from csv
    ...
    #binary search for address in tornado list
